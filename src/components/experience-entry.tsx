            ...
            <div className="flex flex-wrap gap-1 mt-2">
              {experience.links.map((link, index) => (
                <a
                  ...
                  target="_blank"
                  rel="noopener noreferrer"
                  className={`inline-flex items-center gap-2 bg-blue-50 hover:bg-blue-100 text-blue-700 hover:text-blue-900 rounded-md border border-blue-200 transition-all duration-150 font-medium ${link.compact ? 'px-2 py-1.5' : 'px-3 py-1.5'}`}
                >
                  {link.thumbnailSrc && (
                    <Image
